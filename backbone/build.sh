...
# split bundles
browserify -r jquery -r backbone > build/vendor.js
browserify -x jquery -x backbone -r ./shared > build/shared.js
browserify -x jquery -x backbone -x ./shared client.js > build/client.js
